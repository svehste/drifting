...
import { classes, raceOfficials, races, registrations, userRoles, users } from "@/db/schema";
import type { Criterion } from "@/domain/types";
import { isUuid } from "@/lib/validation";
import { addBattleJudge, removeOfficial, setCriterionJudge, updateRace } from "@/server/actions/races";
...
/** Påmelding tab — race settings, judges and driver registrations. */
export default async function RegistrationTabPage({
  params,
}: {
  ...
  // Read sequentially, NOT via Promise.all — see the note in the leaderboard/race
  // queries: a wide pipeline over Supabase's transaction pooler can stall.
